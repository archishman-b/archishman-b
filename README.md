...
[![Open to](https://img.shields.io/badge/Open%20to-AI%20Strategy%20%7C%20S%26O%20%7C%20Product%20%7C%20PM%20roles-6366f1?style=flat-square)](#)
...
*4 of 22 projects live · updating weekly*
...
### [Strategic Initiative Prioritiser](https://archishman-b.github.io/initiative-prioritizer/strategic-initiative-prioritiser.html) · `AI-powered`
BizOps-native strategic decision support tool. Five-dimension scoring model plots a portfolio of initiatives on a priority matrix — Accelerate Now · Build the Case · Delegate · Deprioritise. AI-generated project briefs via the Anthropic API, calibrated to the organisation's language and strategic priorities. Real-time token and cost tracking. Ships with three pre-configured demo contexts (Google gTech Ads S&O · Cisco GTM · ServiceNow S&I) and full initiative lifecycle management. Built from the same prioritisation pattern used across three real consulting engagements — Mahindra dealer network scoring, Monitor Deloitte vendor assessment, Accenture IT investment re-routing.

### [DataBridge](https://archishman-b.github.io/databridge/databridge.html) · `v2.0`
No-code data workbench for consultants and analysts. 40+ operations — joins, aggregations, time intelligence, segmentation — in a single browser file. No installation, no server, works offline. v2.0 adds dark/light theming, Canvas mode (pipeline as a live node graph), and smart stats bar with auto-computed Σ/μ aggregates. Built because I needed it on a pricing engagement where I had one consultant, no SQL access, and no Alteryx licence.
...
- **Pivoting into:** AI Strategy & Advisory · Strategy & Operations (BizOps) · Product Management roles at tech-forward companies
- **Building toward:** Senior AI PM · AI Strategy Lead · S&O Lead · Product Strategy Director
...
If you're working on AI strategy, strategy & operations, product management in the enterprise/automotive/tech space, or building tools for strategy practitioners — I'd love to talk.

**DM me on [LinkedIn](https://linkedin.com/in/archishmanb)** · Open to: advisory conversations, collaboration, and senior AI PM / S&O Lead / product strategy / AI advisory roles at companies building at scale.
